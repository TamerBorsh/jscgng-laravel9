                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('pages.index') }}">الصفحات<i
                                        class="dripicons-chevron-left"></i></a></li>
                            <li class="breadcrumb-item">تعديل البيانات</li>
                        </ol>
                    </div>
                    <h4 class="page-title">تعديل البيانات</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form id="addDataForm" action="" method="page" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="keywords_ar"
                                                        name="keywords_ar" value="{{ $page->keywords_ar }}">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="description_en" class="form-label">الوصف</label>
                                                    <input type="text" class="form-control" id="description_ar"
                                                        name="description_ar" value="{{ $page->description_ar }}">
                                                </div>


                                                <div class="col-md-12">
                                                    <label for="content_ar" class="form-label">المحتوى</label>
                                                    <textarea class="form-control" id="content_ar" name="content_ar" rows="3">{{ $page->content_ar }}</textarea>
                                                </div>
